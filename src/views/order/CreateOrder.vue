<template>
  <div class="create-order">
    <el-header :name="'生成订单'" @callback="deleteLocal"></el-header>
    <div class="address-wrap">
      ...
      <el-icon class="arrow" name="arrow" />
    </div>
    <div class="good">
    ...
    <div class="pay-wrap">
      ...
      <el-button @click="createOrder" class="pay-btn" color="#1baeae" type="primary" plain>我的订单</el-button>
